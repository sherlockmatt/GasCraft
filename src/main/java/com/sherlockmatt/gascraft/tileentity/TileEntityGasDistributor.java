...
public class TileEntityGasDistributor extends TileEntity implements IInventory
{
    ...
    public String getInventoryName() {
        return this.hasCustomInventoryName() ? this.containerName : "container.GasDistributor"; //Used to be func_145818_k_, now hasCustomInventoryName()
    }
